...
class FaqActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        faq["My receipient has multipe numbers, can I choose which one I send messages to?"] = "Of course you can! Simply click the tile for that recipient, click 'optons', then 'Select Number' and pick the number you want to call and send SMS's to, its that easy!"
